...
var ElementSelectorHandler = function ElementSelectorHandler() {
    ...
    this.setEvents = function () {
        ...
        (0, _jquery2.default)('#select-element-menu').draggable({
            handle: '.select-element-menu-handle',
            create: function create() {
                (0, _jquery2.default)('#select-element-menu').css({ 'position': 'absolute' });
            }
        });

        container.on('click', '#selectElementOverlay', function () {
            _this.removeMenu();
            _this.removeOverlay();
        });
    };
...
var _postRobot = require('post-robot');
...
},{"./dist/post-robot":5}],7:[function(require,module,exports){
module.exports = require('./lib/reading-time');

},{"./lib/reading-time":8}],8:[function(require,module,exports){
/*!
 * reading-time
